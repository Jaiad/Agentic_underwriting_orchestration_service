...
class RiskAssessmentStep:
    ...
    def execute(
        ...
        # UPDATED: Use local FAISS RAG via rag_pipeline instead of MongoDB
        rag_context_str = ""
        if self.rag_pipeline:
            rag_context_str = self.rag_pipeline.query(search_query)
        else:
            rag_context_str = "Standard risk assessment guidelines."
        ...
        prompt = RISK_ASSESSMENT_PROMPT.format(
            ...
            guidelines_context=rag_context_str,
        )
